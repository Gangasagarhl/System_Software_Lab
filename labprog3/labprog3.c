...
#include<unistd.h>// used if some flags are set, system() 
#include<stdlib.h> // exit function with EXIT_FAILURE flag

void action(){

	const char *hlgs_filename="lab3.txt";
...
printf("\n\nCreating file named 'lab3.txt' and printing  the file descriptor value. Used creat() function.\n\n");
...
printf("\nAfter creating the file, folder contents are: \n");
system("ls -l");
